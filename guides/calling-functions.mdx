...
description: "Use the python() helper to import a Python module and call its functions as async JavaScript. Supports positional args, keyword args, and all primitive types."
---
...
Python functions that accept keyword arguments can be called by passing a plain JavaScript object as an argument. The bridge serializes it as a Python `dict`, and Python receives it as a positional argument — your Python function can then unpack it or use it directly:
