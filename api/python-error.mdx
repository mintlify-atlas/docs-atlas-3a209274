---
title: "PythonError — Python Exception Bridged to JavaScript"
sidebarTitle: "PythonError"
description: "PythonError extends Error and is thrown when a Python exception crosses the bridge. Inspect message, name, pythonTraceback, and isPythonError."
---
